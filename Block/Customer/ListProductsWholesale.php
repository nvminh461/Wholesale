 ...
 */
namespace Dev\Wholesale\Block\Customer;
 ...
 */
class ListProductsWholesale extends \Magento\Customer\Block\Account\Dashboard
{
    /**
    ...
    {
        dd($this->currentCustomer->getCustomerId());
